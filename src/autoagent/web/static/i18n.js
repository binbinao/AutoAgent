...
const MESSAGES = {
  en: {
    ...
    "history.treeAria": "Task history tree",
    "history.toggle": "Expand or collapse subtasks",
    "history.reportSelect": "Select report to download",
    "history.download": "Download",
    "history.noReports": "No reports",
    "history.noReportsHint": "No Markdown report file for this run",
    "history.reportLabel": "Report",
  ...
  zh: {
    ...
    "history.loading": "加载中…",
    "history.empty": "暂无历史",
    "history.treeAria": "任务历史树",
    "history.toggle": "展开或折叠子任务",
    "history.reportSelect": "选择要下载的报告",
    "history.download": "下载",
    "history.noReports": "无报告",
    "history.noReportsHint": "该任务未生成 Markdown 报告",
    "history.reportLabel": "报告",
    "history.stepCount": "{count} 个步骤",
    "status.idle": "空闲",
    "status.running": "执行中",
